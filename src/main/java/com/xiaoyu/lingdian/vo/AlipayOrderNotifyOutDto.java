...
/**
 * @author  xiqf
 * @date 创建时间：2015年12月11日 上午11:19:37 
 * @version 1.0
 */
public class AlipayOrderNotifyOutDto implements Serializable {
	...
	public Map<String, String> getParametersMap() {
		...
		map.put("extra_common_param", extra_common_param);
		map.put("out_channel_type", out_channel_type);
		map.put("out_channel_amount", out_channel_amount);
		map.put("out_channel_inst", out_channel_inst);
		map.put("business_scene", business_scene);
		return map;
	}
